...
<body>
	...
	<div id='main'>
        <?php if(is_array($wish_list)): foreach($wish_list as $key=>$wish): ?><dl class='paper a<?php echo mt_rand(1, 5);?>'>
			<dt>
            <span class='username'><?php echo ($wish["user"]); ?></span>
            <span class='num'><?php echo ($wish["id"]); ?></span>
			</dt>
            <dd class='content'><?php echo ($wish["content"]); ?></dd>
			<dd class='bottom'>
            <span class='time'><?php echo (date('Y-m-d H:i:s', $wish["ctime"])); ?></span>
